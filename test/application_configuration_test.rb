...
class ApplicationConfigurationTest < ActiveSupport::TestCase
  ...
  test "defines safe demo defaults" do
    ...
    assert_equal 3, configuration.interaction_profile_preview_limit
    ...
    assert_equal 3, configuration.account_import_upload_rate_limit
    assert_equal 1.minute, configuration.account_import_upload_rate_window
  end
