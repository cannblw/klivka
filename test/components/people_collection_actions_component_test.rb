...
class PeopleCollectionActionsComponentTest < ViewComponent::TestCase
  test "keeps name-only creation primary and groups secondary actions" do
    ...
    assert_selector "#people-collection-actions-trigger[aria-controls='people-collection-actions-panel'][aria-expanded='false']", text: "More actions"
    assert_selector "#people-collection-actions-panel.hidden" do
