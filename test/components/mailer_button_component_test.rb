...
class MailerButtonComponentTest < ViewComponent::TestCase
  test "renders an email-safe call-to-action link" do
    render_inline(MailerButtonComponent.new(label: "Open Ada", url: "https://example.com/friends/ada"))

    assert_selector "table[role='presentation'] td[style*='text-align: center'] a[href='https://example.com/friends/ada']", text: "Open Ada"
