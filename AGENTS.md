...
- Do not add tests whose purpose is to assert exact translations or locale-specific wording. Test localized UI through behavior and stable semantic structure without duplicating assertions for each locale.
